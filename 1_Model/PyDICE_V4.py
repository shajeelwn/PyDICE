...
class PyDICE(object):
    ...
    def __call__(self,
        ...
        self.data = {'Atmospheric Temperature 2010': self.temp_atm[0],
                     'Damages 2010': self.damages[0],
                     # 'Industrial Emission 2010': self.eind[0],
                     'Utility 2010': self.util[0],
                     'Total Output 2010': self.y[0],
                     
                     'Atmospheric Temperature 2050': self.temp_atm[8],
                     'Damages 2050': self.damages[8],
                     # 'Industrial Emission 2050': self.eind[8],
                     'Utility 2050': self.util[8],
                     'Total Output 2050': self.y[8],
                     
                     'Atmospheric Temperature 2100': self.temp_atm[18],
                     'Damages 2100': self.damages[18],
                     # 'Industrial Emission 2100': self.eind[18],
                     'Utility 2100': self.util[18],
                     'Total Output 2100': self.y[18],
                     
                     'Atmospheric Temperature 2150': self.temp_atm[28],
                     'Damages 2150': self.damages[28],
                     # 'Industrial Emission 2150': self.eind[28],
                     'Utility 2150': self.util[28],
                     'Total Output 2150': self.y[28],
                     
                     'Atmospheric Temperature 2200': self.temp_atm[38],
                     'Damages 2200': self.damages[38],
                     # 'Industrial Emission 2200': self.eind[38],
                     'Utility 2200': self.util[38],
                     'Total Output 2200': self.y[38],
                     
                     'Atmospheric Temperature 2300': self.temp_atm[58],
                     'Damages 2300': self.damages[58],
                     # 'Industrial Emission 2300': self.eind[58],
                     'Utility 2300': self.util[58],
